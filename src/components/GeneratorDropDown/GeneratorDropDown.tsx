...
//
// import { HiLink, HiCurrencyDollar } from "react-icons/hi";
...
//   });
//
//   function changeValue(newLabel: string, newIcon: JSX.Element) {
//     setSelectedValue({ label: newLabel, icon: newIcon });
//   }
//
//   return (
...
//     >
//       <Dropdown.Item
//         onClick={() => changeValue("Website", <HiLink />)}
//         icon={HiLink}
//       >
//         Website
//       </Dropdown.Item>
//       <Dropdown.Item
//         onClick={() => changeValue("Email", <HiCurrencyDollar />)}
//         icon={HiCurrencyDollar}
//       >
//         Email
//       </Dropdown.Item>
//       <Dropdown.Item
//         onClick={() => changeValue("Mp3", <HiCurrencyDollar />)}
//         icon={HiCurrencyDollar}
//       >
//         Mp3
//       </Dropdown.Item>
